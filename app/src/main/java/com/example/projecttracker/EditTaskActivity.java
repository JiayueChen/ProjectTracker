...
public class EditTaskActivity extends Activity implements View.OnTouchListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		task_discription.setText(task.getTask_desription());
		date_time=(EditText)findViewById(R.id.date_time_EditText);
		date_time.setText(task.getDate_time());
		...
		liststudentanme=stringToList(task.getList_of_student());
		task_schedule_list=stringToList(task.getTaskschedule());		
		...
		task_add.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {				
				...
				db.updateTask(task);
				Toast.makeText(EditTaskActivity.this, "Save success!", Toast.LENGTH_SHORT).show();
		      	db.close();
				Intent intent2 = new Intent();
				intent2.putExtra("task_id", task_id);
				intent2.putExtra("project_id", project_id);
				intent2.setClass(EditTaskActivity.this, TaskViewActivity.class);		
		...
		add_student.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {				
		          ...
		          View view = View.inflate(EditTaskActivity.this, R.layout.add_student, null); 
		          ...
		          builder.setPositiveButton("OK", new DialogInterface.OnClickListener() { 	   
		                  ...
		                  public void onClick(DialogInterface dialog, int which) {  
		                	  ...
		                	  student_listview.setAdapter(new ArrayAdapter<String>(EditTaskActivity.this, android.R.layout.simple_expandable_list_item_1,liststudentanme));               		
		                      dialog.cancel(); 
		                  } 
		              }); 
		...
		add_schedule.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {				
				 AlertDialog.Builder builder = new AlertDialog.Builder(EditTaskActivity.this); 
		          View view1 = View.inflate(EditTaskActivity.this, R.layout.add_taskschedule, null); 
		          ...
		          builder.setPositiveButton("OK", new DialogInterface.OnClickListener() { 	   
		                  ...
		                  public void onClick(DialogInterface dialog, int which) {  
		                	  ...
		                	  task_schedule_listview.setAdapter(new ArrayAdapter<String>(EditTaskActivity.this, android.R.layout.simple_expandable_list_item_1,task_schedule_list));               		
		                      dialog.cancel(); 
		                  } 
		              }); 
		          builder.setNegativeButton("Back", new DialogInterface.OnClickListener() { 	   
		...
		student_listview.setOnItemLongClickListener(new OnItemLongClickListener()
		{
			...
			public boolean onItemLongClick(AdapterView<?> arg0,
				...
				// TODO Auto-generated method stub
				      new AlertDialog.Builder(EditTaskActivity.this).setTitle("Delete").setMessage("Are you sure to delete this student?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					  public void onClick(DialogInterface dialog, int which) {
		...
		task_schedule_listview.setOnItemLongClickListener(new OnItemLongClickListener()
		{
			...
			public boolean onItemLongClick(AdapterView<?> arg0,
				 ...
				 final int index=arg2;
				// TODO Auto-generated method stub
				      new AlertDialog.Builder(EditTaskActivity.this).setTitle("Delete").setMessage("Are you sure to delete this schedule?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					  public void onClick(DialogInterface dialog, int which) {
	 ...
	 public boolean onTouch(View v, MotionEvent event) { 
       if (event.getAction() == MotionEvent.ACTION_DOWN) {    
           AlertDialog.Builder builder2 = new AlertDialog.Builder(EditTaskActivity.this); 
           View view = View.inflate(EditTaskActivity.this, R.layout.date_time_dialog, null); 
